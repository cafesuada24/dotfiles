...
| 2 | Did I READ the agent's `.md` file (or recall its rules)? | → STOP. Open `agent/{agent}.md` |
...
> 1. `ARCHITECTURE/agent.json` to understand Agents, Skills, and Scripts.
> 2. `memory/MEMORY.md` to load persistent project conventions, user preferences, and decisions.
...
| Task         | Read                            |
| ------------ | ------------------------------- |
| Web UI/UX    | `agents/frontend-specialist/agent.json` |
| Mobile UI/UX | `agents/mobile-developer/agent.json`    |
